...
export default function UpdateNotification({ caseId, caseTitle, updateId, onClose }: UpdateNotificationProps) {
  ...
  // No longer needed as we're removing the View Update button

  if (!isVisible) return null

  return (
    <div className={`fixed top-4 right-4 bg-slate-800 border border-purple-500 rounded-lg shadow-lg p-4 max-w-sm w-full z-50 transition-all duration-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-[-8px]'}`}>

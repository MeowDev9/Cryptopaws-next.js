...
const GOOGLE_CLIENT_ID =
  "939434414505-na4go0ebln3se9ms9m3sfl41edie3una.apps.googleusercontent.com"

export default function LoginPage() {
  const [isSignUp, setIsSignUp] = useState(false)
  type Role = "Admin" | "Welfare" | "Doctor" | "Donor"
  ...
  const handleFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (isSignUp) {
      ...
      data = { name, email, password, role: "Donor" } // only donors can sign up
    } else {
      switch (role) {
        case "Admin":
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      ...
      <div className="relative min-h-screen flex items-center justify-center px-4 py-20 my-24">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute bottom-20 right-10 w-64 h-64 bg-pink-600/10 rounded-full blur-3xl" />
        </div>

        <div className="relative z-10 w-full max-w-md">
          {/* ---------- ANIMATE PRESENCE WRAPS THE CARD ---------- */}
            ...
            >
              ...
              <div className="p-8">
                <form onSubmit={handleFormSubmit} className="space-y-5">
                  {/* AnimatePresence for the extra Full-Name field */}
